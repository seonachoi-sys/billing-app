...
const Statistics = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeSection === 'qty' && <QtySection ledger={ledger} hospitalMeta={hospitalMeta} statsMemo={statsMemo} setStatsMemo={setStatsMemo} />}
      {activeSection === 'revenue' && <RevenueSection ledger={ledger} hospitalMeta={hospitalMeta} statsMemo={statsMemo} setStatsMemo={setStatsMemo} />}
      {activeSection === 'salesRep' && <SalesRepSection ledger={ledger} hospitalMeta={hospitalMeta} />}
    </div>
  );
};
